      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black text-wine-800 mb-4">오시는 길</h2>
            <p className="text-xl text-wine-600">길을여는교회 이음카페를 찾아주세요</p>
          </div>
          
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* 지도 */}
            <div className="bg-gradient-ivory rounded-3xl p-8 shadow-large">
              <div className="aspect-[4/3] bg-gradient-to-br from-wine-100 to-wine-200 rounded-2xl flex items-center justify-center">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3165.4654564649!2d126.9784042!3d37.5665164!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x357ca2e8e3c9b6a1%3A0x1234567890abcdef!2s길을여는교회!5e0!3m2!1sko!2skr!4v1234567890123"
                  width="100%"
                  height="100%"
            ...
            {/* 위치 정보 */}
            <div className="animate-fade-in">
              <h3 className="text-3xl font-black text-wine-800 mb-8">위치 정보</h3>
              
              <div className="space-y-6">
                <div className="flex items-start">
                  <div className="w-12 h-12 bg-wine-600 rounded-xl flex items-center justify-center mr-4 mt-1">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-wine-800 mb-2">주소</h4>
                    <p className="text-wine-600">서울특별시 종로구 교회로 123</p>
                    <p className="text-wine-600">길을여는교회 1층</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-wine-800 mb-2">연락처</h4>
                    <p className="text-wine-600">02-1234-5678</p>
                    <p className="text-wine-600">cafe@gileulyeoneun.org</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-wine-800 mb-2">운영시간</h4>
                    <p className="text-wine-600">평일: 09:00 - 21:00</p>
                    <p className="text-wine-600">주말: 10:00 - 20:00</p>
                    <p className="text-wine-600">일요일: 12:00 - 18:00</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-xl font-bold text-wine-800 mb-2">교통편</h4>
                    <p className="text-wine-600">지하철 3호선 안국역 2번 출구</p>
                    <p className="text-wine-600">도보 5분</p>
                    <p className="text-wine-600">버스 109, 151, 171, 272</p>
                  </div>
                </div>
              </div>
            </div>
