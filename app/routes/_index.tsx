                  ...
                  <div className="contents sm:block sm:space-y-2.5">
                    ...
                    {newsData?.offeringAccounts && newsData.offeringAccounts.length > 0 && (
                      <div className="rounded-xl border border-hairline bg-surface-soft px-3 py-3">
                        ...
                        {/* 소셜 링크 */}
                        <div className="flex items-center gap-2 mt-2.5 pt-2 border-t border-hairline">
                          <a
                            href="https://www.youtube.com/channel/UCIjrJ4vu_SWMNPM9FyISPOw"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-canvas border border-hairline hover:bg-red-50 hover:border-red-200 transition-colors group"
                          >
                          ...
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-canvas border border-hairline hover:bg-pink-50 hover:border-pink-200 transition-colors group"
                          >
